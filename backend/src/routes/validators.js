...
export const schemas = {
  ...
  createCompany: Joi.object({
    ...
    checkInRadiusMeters: Joi.number().min(50).max(5000),
  }),
  ...
  packageBody: Joi.object({
    ...
    features: Joi.object({
      ...
      distributorManagement: Joi.boolean(),
  ...
  createStaff: Joi.object({
    ...
    designation: objectId.allow(null, ''),
    shift: objectId.allow(null, ''),
    branch: objectId.allow(null, ''),
    workMode: Joi.string().valid('INDOOR', 'OUTDOOR'),
  ...
  updateStaff: Joi.object({
    ...
    monthlyTarget: Joi.number().min(0),
    role: Joi.string().valid('STAFF', 'COMPANY_MANAGER', 'ADMIN_EMPLOYEE'),
    subRole: Joi.string().valid('ADMIN', 'HR', 'SUPPORT', 'FINANCE').allow(null),
    designation: objectId.allow(null, ''),
    shift: objectId.allow(null, ''),
