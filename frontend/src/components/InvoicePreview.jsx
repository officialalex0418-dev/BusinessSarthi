    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row border-2 border-black font-sans font-bold overflow-hidden items-stretch bg-white shrink-0 break-inside-avoid print:mt-10 print:flex-row print:h-16">
          <div className="bg-[#9e9e9e] px-4 py-2 flex items-center gap-3 border-b-2 sm:border-b-0 sm:border-r-2 border-black flex-1">
            ...
            <div className="leading-tight">
              ...
              <p className="text-[7px] font-medium italic opacity-90">{appBranding.tagline || 'Driving Business Forward'}</p>
            </div>
          </div>

          <div className="flex-[1.2] bg-[#cecece] flex items-center justify-center px-2 border-r-2 border-black">
          ...
          <div className="bg-[#9e9e9e] px-4 flex flex-col justify-center text-[8px] leading-tight min-w-[180px]">
